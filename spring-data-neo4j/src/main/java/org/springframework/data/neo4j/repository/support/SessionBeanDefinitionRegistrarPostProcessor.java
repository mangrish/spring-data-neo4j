...
public class SessionBeanDefinitionRegistrarPostProcessor  implements BeanFactoryPostProcessor {
	...
	public static Collection<SessionFactoryProviderBeanDefinition> getEntityManagerFactoryBeanDefinitions(
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		...
		for (SessionFactoryProviderBeanDefinition definition : getEntityManagerFactoryBeanDefinitions(beanFactory)) {
